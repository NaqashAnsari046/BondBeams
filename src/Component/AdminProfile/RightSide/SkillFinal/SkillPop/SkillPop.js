...
import Select from "../../../../../ReuseableCode/DropDown/Select";
import Gender from "./Gender";
import { useNavigate } from "react-router-dom";



function ExpPOST({ExpUpdateFun, ExpUpdate,ProfileGet}) {
  ...
  const ExpPOSTBTN = async () => {
    ...
    // console.log(experience_title, company_name, discription,);
